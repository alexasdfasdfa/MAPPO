...
def parser_args_eval(args, parser):
    ...
    parser.add_argument("--log_dir", type=str, default="/home/inno/proj/MAPPO/results/train/run27/logs")
    parser.add_argument("--save_dir", type=str, default="/home/inno/proj/MAPPO/results/eval/run27")
...
def main(args):
    ...
    # 合并参数
    MODEL_DIR = all_args.model_dir if all_args.model_dir else "/home/inno/proj/MAPPO/results/train/run27/models"
