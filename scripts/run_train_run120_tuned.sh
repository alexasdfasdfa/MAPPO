...
# Improve sample efficiency / stability.
NUM_MINI_BATCH="${NUM_MINI_BATCH:-200}"
ENTROPY_COEF="${ENTROPY_COEF:-0.015}"

# Reward shaping tuned toward faster/shorter successful formation.
V3_REWARD_M_DROP_SCALE="${V3_REWARD_M_DROP_SCALE:-0.70}"
V3_REWARD_S_DROP_SCALE="${V3_REWARD_S_DROP_SCALE:-0.20}"
V3_REWARD_TRAVEL_PENALTY_SCALE="${V3_REWARD_TRAVEL_PENALTY_SCALE:-0.04}"
...
V3_SELECTOR_PROGRESS_BONUS_SCALE="${V3_SELECTOR_PROGRESS_BONUS_SCALE:-0.25}"
UNDET_V2_SL_DENSE_SCALE="${UNDET_V2_SL_DENSE_SCALE:-0.25}"
UNDET_V2_SL_DELTA_SCALE="${UNDET_V2_SL_DELTA_SCALE:-0.70}"
UNDET_V2_SL_SUCCESS_SCALE="${UNDET_V2_SL_SUCCESS_SCALE:-2.50}"
UNDET_V2_SL_SUCCESS_THRESHOLD="${UNDET_V2_SL_SUCCESS_THRESHOLD:-0.97}"
ND_ARRIVAL_REWARD="${ND_ARRIVAL_REWARD:-0.80}"
ND_GOAL_TERMINAL_REWARD="${ND_GOAL_TERMINAL_REWARD:-1.80}"
...
if [[ "${REWARD_TRAIN_MODE}" == "motion_first" ]]; then
  ...
  V3_CURRICULUM_MOTION_PHASE_RATIO="${V3_CURRICULUM_MOTION_PHASE_RATIO:-0.25}"
  V3_CURRICULUM_MOTION_REWARD_BOOST="${V3_CURRICULUM_MOTION_REWARD_BOOST:-1.7}"
  V3_CURRICULUM_SELECTOR_REWARD_EARLY="${V3_CURRICULUM_SELECTOR_REWARD_EARLY:-0.65}"
  V3_CURRICULUM_SELECTOR_REWARD_LATE="${V3_CURRICULUM_SELECTOR_REWARD_LATE:-1.40}"
  V3_CURRICULUM_SELECTOR_KL_EARLY="${V3_CURRICULUM_SELECTOR_KL_EARLY:-0.55}"
