...
class JointState(object):
    def __init__(self, robot1_state, robot2_state, robot3_state, human_states):
        # assert isinstance(robot1_state, FullState)
        # for human_state in human_states:
        #     assert isinstance(human_state, ObservableState)

        self.robot1_state = robot1_state
        self.robot2_state = robot2_state
        self.robot3_state = robot3_state
