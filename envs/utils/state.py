...
class ObservableState(object):
    def __init__(self, px, py, vx, vy, radius):
        ...
        self.position = (self.px, self.py)
        self.velocity = (self.vx, self.vy)
        # print('self.human_states:',self.position,self.velocity)
...
class JointState(object):
    def __init__(self, self_state, human_states):
        ...
        # print('self.self_state:',self.self_state)

class Trans_OB(object):
    def __init__(self, robot1_state, robot2_state, human_states):


        self.robot_self_state = robot1_state
        self.robots_other_state = robot2_state
        self.human_states = human_states  